...
class Index extends React.Component {
    ...
    render() {
        ...
        return <antd_1.Form className={index_scss_1.cx({ imsInfo: true })}>
            <antd_1.Form.Item className="detail">
            ...
            <antd_1.Form.Item>
                <div className={index_scss_1.cx({ footerBar: true })}>
                    <antd_1.Checkbox onChange={e => this.setState({
            agree: e.target.checked
        })}>我已仔细阅读并理解此协议</antd_1.Checkbox>
                    <antd_1.Button {...btnProps}>下一步</antd_1.Button>
                </div>
            </antd_1.Form.Item>
        </antd_1.Form>;
    }
