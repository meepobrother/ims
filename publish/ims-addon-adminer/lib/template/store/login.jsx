...
const user_1 = __importDefault(require("../inc/user"));
class Login {
    constructor() {
        // 记住
        this.autoLogin = true;
                ...
                onSubmit: (err, values) => {
                    ...
                    this.login({
                        ...
                        if (res.code !== 0) {
                            ...
                            // 跳转
                            const user = res.data;
                            ims_adminer_1.role.setRole(user.role);
                            ims_adminer_1.role.username = user.username;
     ...
     */
    login(data) {
        return user_1.default.login(data);
    }
    /**
     * 退出登录
     **/
    logout() {
        ims_adminer_1.role.role = 'default';
        ims_adminer_1.role.username = '';
        ims_util_1.default.cookie.remove('token', {
            path: '/'
        });
        ims_adminer_1.history.push('/home/login');
    }
    /**
     * 注册
     */
