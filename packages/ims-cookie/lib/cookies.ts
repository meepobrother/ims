...
import { parseCookies, readCookie, hasDocumentCookie } from './util';
import {
    Cookie,
    CookieGetOptions,
...
export class ImsCookie {
    ...
    public set(name: string, value: Cookie, options?: cookie.CookieSetOptions) {
    ...
    public remove(name: string, options?: cookie.CookieSetOptions) {
