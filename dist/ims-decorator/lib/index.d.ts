...
export declare class ClassAst<T = any> extends Ast<T> {
    constructor(target: any, metadataKey: string, metadataDef: T, sourceRoot: string);
...
export declare class ParserManager {
    static _visitor: AstVisitor;
    static _map: Map<any, ParserAstContext>;
    static visitor: AstVisitor;
    static getContext(target: any): any;
}
