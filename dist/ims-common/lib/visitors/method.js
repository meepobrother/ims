...
class MethodVisitor extends ims_decorator_1.NullAstVisitor {
    visitProperty(ast, context) {
        ...
        if (ims_core_1.isAllPropertyAst(ast)) {
            return new ims_core_1.AllPropertyAst(ast, context);
        }
    }
    visitMethod(ast, context) {
        ...
        if (ims_core_1.isAllMethodAst(ast)) {
            return new ims_core_1.AllMethodAst(ast, context);
        }
    }
}
